...
项目由 **ZeroRaltal** 制作，保留作者署名即可自由转载、修改。
...
- **智能乐器映射** – 将 GM/打击乐映射至 Minecraft 原版音色（如 harp、bell、flute、bd、snare 等）。
- **一键生成命令** – 自动生成初始化、循环、连锁命令方块指令，并按时间点去重。
